...
public class TimeTrackApprovalRowMapper implements RowMapper<TaskTrackApproval> {
	...
	public TaskTrackApproval mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		rpt.setFirstHalfStatus(rs.getString("first_half_status")!=null ? rs.getString("first_half_status") : Constants.TASKTRACK_APPROVER_STATUS_OPEN);
		rpt.setSecondHalfStatus(rs.getString("second_half_status")!=null ? rs.getString("second_half_status") : Constants.TASKTRACK_APPROVER_STATUS_OPEN);
		return rpt;
	}
