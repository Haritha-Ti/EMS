...
public interface AllocationRepository extends JpaRepository<AllocationModel, Long> {
	...
	public List<AllocationModel> findByProjectProjectIdAndStartDateLessThanEqualAndEndDateGreaterThanEqualAndActive(
			Long projectId, Date endDate, Date startDate, Boolean isActive);
}
