...
@Repository
public interface TaskTrackFinalJPARepository extends JpaRepository<TaskTrackApprovalFinal, Long> {
	 ...
	 * +
	 * "sum(COALESCE(day31,0)) as day31 FROM tasktrack_approval_final where user_user_id=?3 and month=?1 and year=?2 and project_type in('Billable','Overtime','Non-Billable')"
	 * ,nativeQuery = true)
	 */
	@Query(value = "SELECT user_user_id as id,(sum(COALESCE(day1,0))+sum(COALESCE(day2,0))+sum(COALESCE(day3,0))+sum(COALESCE(day4,0))+sum(COALESCE(day5,0))+sum(COALESCE(day6,0))+sum(COALESCE(day7,0))+"
			...
			+ "sum(COALESCE(day29,0))+sum(COALESCE(day30,0))+sum(COALESCE(day31,0))) as totalhour FROM tasktrack_approval_final f"
	...
	@Query(value = "SELECT user_user_id as id,(sum(COALESCE(day1,0))+sum(COALESCE(day2,0))+sum(COALESCE(day3,0))+sum(COALESCE(day4,0))+sum(COALESCE(day5,0))+sum(COALESCE(day6,0))+sum(COALESCE(day7,0))+"
			+ "sum(COALESCE(day8,0))+sum(COALESCE(day9,0))+sum(COALESCE(day10,0))+sum(COALESCE(day11,0))+sum(COALESCE(day12,0))+sum(COALESCE(day13,0))+sum(COALESCE(day14,0))+"
			+ "sum(COALESCE(day15,0))) as totalhour FROM tasktrack_approval_final where user_user_id=?3 and month=?1 and year=?2 and project_type in('Billable','Overtime','Non-Billable')", nativeQuery = true)
	...
	@Query(value = "SELECT user_user_id as id,(sum(COALESCE(day1,0))+sum(COALESCE(day2,0))+sum(COALESCE(day3,0))+sum(COALESCE(day4,0))+sum(COALESCE(day5,0))+sum(COALESCE(day6,0))+sum(COALESCE(day7,0))+"
			...
			+ "sum(COALESCE(day15,0))+sum(COALESCE(day16,0))+sum(COALESCE(day17,0))+sum(COALESCE(day18,0))+sum(COALESCE(day19,0))+sum(COALESCE(day20,0))+sum(COALESCE(day21,0))+"
			+ "sum(COALESCE(day22,0))+sum(COALESCE(day23,0))+sum(COALESCE(day24,0))+sum(COALESCE(day25,0))+sum(COALESCE(day26,0))+sum(COALESCE(day27,0))+sum(COALESCE(day28,0))+"
			+ "sum(COALESCE(day29,0))+sum(COALESCE(day30,0))+sum(COALESCE(day31,0))) as billablehour FROM tasktrack_approval_final where user_user_id=?3 and month=?1 and year=?2 and project_type in('Billable')", nativeQuery = true)
	List<Object[]> getBillableDataByUserId(Integer monthIndex, Integer yearIndex, Long id);

	@Query(value = "SELECT user_user_id as id,(sum(COALESCE(day1,0))+sum(COALESCE(day2,0))+sum(COALESCE(day3,0))+sum(COALESCE(day4,0))+sum(COALESCE(day5,0))+sum(COALESCE(day6,0))+sum(COALESCE(day7,0))+"
			+ "sum(COALESCE(day8,0))+sum(COALESCE(day9,0))+sum(COALESCE(day10,0))+sum(COALESCE(day11,0))+sum(COALESCE(day12,0))+sum(COALESCE(day13,0))+sum(COALESCE(day14,0))+"
			+ "sum(COALESCE(day15,0))) as billablehour FROM tasktrack_approval_final where user_user_id=?3 and month=?1 and year=?2 and project_type in('Billable')", nativeQuery = true)
	...
	@Query(value = "SELECT user_user_id as id,(sum(COALESCE(day1,0))+sum(COALESCE(day2,0))+sum(COALESCE(day3,0))+sum(COALESCE(day4,0))+sum(COALESCE(day5,0))+sum(COALESCE(day6,0))+sum(COALESCE(day7,0))+"
			...
			+ "sum(COALESCE(day15,0))+sum(COALESCE(day16,0))+sum(COALESCE(day17,0))+sum(COALESCE(day18,0))+sum(COALESCE(day19,0))+sum(COALESCE(day20,0))+sum(COALESCE(day21,0))+"
			+ "sum(COALESCE(day22,0))+sum(COALESCE(day23,0))+sum(COALESCE(day24,0))+sum(COALESCE(day25,0))+sum(COALESCE(day26,0))+sum(COALESCE(day27,0))+sum(COALESCE(day28,0))+"
			+ "sum(COALESCE(day29,0))+sum(COALESCE(day30,0))+sum(COALESCE(day31,0))) as billablehour FROM tasktrack_approval_final where user_user_id=?3 and month=?1 and year=?2 and project_type in('Non-Billable')", nativeQuery = true)
	List<Object[]> getNonBillableDataByUserId(Integer monthIndex, Integer yearIndex, Long id);

	@Query(value = "SELECT user_user_id as id,(sum(COALESCE(day1,0))+sum(COALESCE(day2,0))+sum(COALESCE(day3,0))+sum(COALESCE(day4,0))+sum(COALESCE(day5,0))+sum(COALESCE(day6,0))+sum(COALESCE(day7,0))+"
			+ "sum(COALESCE(day8,0))+sum(COALESCE(day9,0))+sum(COALESCE(day10,0))+sum(COALESCE(day11,0))+sum(COALESCE(day12,0))+sum(COALESCE(day13,0))+sum(COALESCE(day14,0))+"
			+ "sum(COALESCE(day15,0))) as billablehour FROM tasktrack_approval_final where user_user_id=?3 and month=?1 and year=?2 and project_type in('Non-Billable')", nativeQuery = true)
	...
	@Query(value = "SELECT user_user_id as id,(sum(COALESCE(day1,0))+sum(COALESCE(day2,0))+sum(COALESCE(day3,0))+sum(COALESCE(day4,0))+sum(COALESCE(day5,0))+sum(COALESCE(day6,0))+sum(COALESCE(day7,0))+"
			...
			+ "sum(COALESCE(day15,0))+sum(COALESCE(day16,0))+sum(COALESCE(day17,0))+sum(COALESCE(day18,0))+sum(COALESCE(day19,0))+sum(COALESCE(day20,0))+sum(COALESCE(day21,0))+"
			+ "sum(COALESCE(day22,0))+sum(COALESCE(day23,0))+sum(COALESCE(day24,0))+sum(COALESCE(day25,0))+sum(COALESCE(day26,0))+sum(COALESCE(day27,0))+sum(COALESCE(day28,0))+"
			+ "sum(COALESCE(day29,0))+sum(COALESCE(day30,0))+sum(COALESCE(day31,0))) as billablehour FROM tasktrack_approval_final where user_user_id=?3 and month=?1 and year=?2 and project_type in('Overtime')", nativeQuery = true)
	List<Object[]> getOvertimeDataByUserId(Integer monthIndex, Integer yearIndex, Long id);

	@Query(value = "SELECT user_user_id as id,(sum(COALESCE(day1,0))+sum(COALESCE(day2,0))+sum(COALESCE(day3,0))+sum(COALESCE(day4,0))+sum(COALESCE(day5,0))+sum(COALESCE(day6,0))+sum(COALESCE(day7,0))+"
			+ "sum(COALESCE(day8,0))+sum(COALESCE(day9,0))+sum(COALESCE(day10,0))+sum(COALESCE(day11,0))+sum(COALESCE(day12,0))+sum(COALESCE(day13,0))+sum(COALESCE(day14,0))+"
			+ "sum(COALESCE(day15,0))) as billablehour FROM tasktrack_approval_final where user_user_id=?3 and month=?1 and year=?2 and project_type in('Overtime')", nativeQuery = true)
	List<Object[]> getOvertimeDataByUserIdMidMonth(Integer monthIndex, Integer yearIndex, Long id);

	@Query(value = "SELECT s.forwarded_date FROM tasktrack_approval_final s WHERE s.month = ?3 and s.year = ?4 and s.project_project_id = ?1 and s.user_user_id = ?2 LIMIT 1 ", nativeQuery = true)
	List<Object> getForwardedDate(Long projectId, Long userId, int intMonth, int year);

	@Query(value = "SELECT s.forwarded_date,s.forwarded_finance,s.approved_date FROM tasktrack_approval_final s WHERE s.month = ?3 and s.year = ?4 and s.project_project_id = ?1 and s.user_user_id = ?2 LIMIT 1 ", nativeQuery = true)
	List<Object[]> getForwardedDates(Long projectId, Long userId, int intMonth, int yearIndex);

	@Query(value = "SELECT count(*) as totalrow FROM tasktrack_approval_final WHERE month=?1 and  year=?2 and project_project_id=?3 ", nativeQuery = true)
	Long getCountOfRows(int month, int year, Long projectId);

	@Query("SELECT a FROM TaskTrackApprovalFinal a  where a.project.projectId = ?1 and a.month = ?2 and a.year = ?3 and a.projectType = 'Billable' ")
	TaskTrackApprovalFinal getDataForCheckingForwardedToLevel2(Long projectId, int intMonth, int yearIndex);

	@Query(value = "SELECT count(*) as totalrow FROM tasktrack_approval_final WHERE month=?1 and  year=?2 and project_project_id=?3 and user_user_id=?4", nativeQuery = true)
	Long getCountOfRowsByUser(int month, int year, Long projectId, Long userId);

	@Query(value = "SELECT  approved_date FROM tasktrack_approval_final WHERE month=?1 and  year=?2 and project_project_id=?3 and user_user_id=?4 and project_type = 'Billable'", nativeQuery = true)
	...
	List<TaskTrackApprovalFinal> upadateTaskTrackApprovalFinalStatus(Long projectId, int intMonth, int year,
			Long userId);

	List<TaskTrackApprovalFinal> findByUserUserIdAndProjectProjectIdAndMonthAndYear(Long userId, Long projectId,
