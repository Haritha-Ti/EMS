...
@Query(value="  select sm.monthly_id ,sm.trx_date  ,sm.approver_one_first_half_status, sm.approver_one_first_half_submitted_date ,sm.approver_one_second_half_status, sm.approver_one_second_half_submitted_date ,"
	...
	+ " sm.first_half_aapprover_two_id_user_id  ,sm.first_half_finance_id_user_id ,case when sm.revtype=0  then 'Created' when sm.revtype=1  then 'Updated'  when sm.revtype=2  then 'Deleted' end as trxn,u.first_name as user,ap1.first_name as approver1,"
